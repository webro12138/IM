...
# 支持单层网络数据集
SINGLE_LAYER_NETWORK_DATASETS = ["facebook", "soc-wiki-Vote", "CA-HepTh", "CA-AstroPh", "aren-email", "stelzl", "deezer_target", "facebook", "filmtrust", "lastfm_asia", "NetPHY", "hamster-friend"]
